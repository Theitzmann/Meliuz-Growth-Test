...
📦 Meliuz-Growth-Test
 ...
 ┣ 📜 credentials.json # Não irá aparecer; chave de acesso para a planilha do Google Sheets
...
Os pacotes como `pandas` e `gspread` foram instalados de forma isolada. Por isso, antes de rodar o código, é preciso ativar a máquina virtual (venv).
